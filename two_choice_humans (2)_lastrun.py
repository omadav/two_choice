...
expName = u'two_choice_juice_money'  # from the Builder filename that created this script
expInfo = {u'session': u'001', u'participant': u'001', u'use_scanner': u'0', u'reward': u'juice'}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\Display\\Documents\\oDoherty_lab\\Omar\\two_choice\\two_choice_humans (2).psyexp',
...
win = visual.Window(
    ...
    monitor=u'testMonitor', color=[0.506,0.506,0.506], colorSpace='rgb',
...
# Import libraries
import numpy as np, csv, random, pumps
...
selection_arrow = visual.ImageStim(
    ...
    image=u'stim/arrow.png', mask=None,
...
left_feedback = visual.ImageStim(
    ...
    image=u'stim/noReward.png', mask=None,
...
right_feedback = visual.ImageStim(
    ...
    image=u'stim/reward.png', mask=None,
    ori=0, pos=[0.5, 0], size=.4,
    color=[1,1,1], colorSpace='rgb', opacity=1,
    flipHoriz=False, flipVert=False,
    texRes=128, interpolate=True, depth=-1.0)
